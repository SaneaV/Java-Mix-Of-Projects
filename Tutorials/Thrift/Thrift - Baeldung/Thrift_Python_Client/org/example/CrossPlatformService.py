...
class Client(Iface):
    ...
    def toString(self, resource):
        ...
        """
        self.send_toString(resource)
        return self.recv_toString()

    def send_toString(self, resource):
        self._oprot.writeMessageBegin('toString', TMessageType.CALL, self._seqid)
        args = toString_args()
        args.resource = resource
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_toString(self):
        ...
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "toString failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["toString"] = Processor.process_toString
    ...
    def process_toString(self, seqid, iprot, oprot):
        args = toString_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = toString_result()
        try:
            result.success = self._handler.toString(args.resource)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("toString", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.e = EntityNotFoundException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
get_result.thrift_spec = (
    ...
    (1, TType.STRUCT, 'e', [EntityNotFoundException, None], None, ),  # 1
)
...
class toString_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('toString_args')
        if self.resource is not None:
            oprot.writeFieldBegin('resource', TType.STRUCT, 1)
            self.resource.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(toString_args)
toString_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'resource', [CrossPlatformResource, None], None, ),  # 1
)


class toString_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('toString_result')
        if self.success is not None:
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(toString_result)
toString_result.thrift_spec = (
